...
function table1() {
    ...
    var selectedValue = selectBox.options[selectBox.selectedIndex].value;
    if(selectedValue=='single'){
        // remote.getCurrentWindow().loadURL(path.join(__dirname, '/tab1End.html'));
...
AddExtrasPlayer1.addEventListener('click',function(event){
   ...
   var cigHead= document.createElement("p");
   var Cigarettes=document.createTextNode("Cigarettes");

    cigHead.appendChild(Cigarettes);
...
AddExtrasPlayer2 = document.getElementById("extrasP2")
AddExtrasPlayer2.addEventListener('click',function(event){
    var body=document.getElementById("body");
    var tableTypeText=document.createElement("h1")
    tableTypeText.innerHTML="Player Name: "+remote.getGlobal('sharedObj').player2
    var br0 =document.createElement("br");
   var teamHead= document.createElement("p");
   var Cigarettes=document.createTextNode("Cigarettes");
